...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-item">
        <Link to="/branches" className={`sidebar-link ${isActive("/branches")}`}>
      ...
      <div className="sidebar-item">
        <Link to="/card-scheme" className={`sidebar-link ${isActive("/card-scheme")}`}>
      ...
      <div className="sidebar-item">
        <Link to="/card-profile" className={`sidebar-link ${isActive("/card-profile")}`}>
      ...
      <div className="sidebar-item">
        <Link to="/card-request" className={`sidebar-link ${isActive("/card-request")}`}>
      ...
      <div className="sidebar-item">
        <Link to="/authorization-list" className={`sidebar-link ${isActive("/authorization-list")}`}>
      ...
      <div className="sidebar-item">
        <Link to="/authorization-queue" className={`sidebar-link ${isActive("/authorization-queue")}`}>
